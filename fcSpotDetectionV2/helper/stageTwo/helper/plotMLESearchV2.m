        ...
        if iscell(theta0s{ii})
            for jj = 1:numel(theta0s{ii})
                if isobject(theta0s{ii}{jj}{1})
                    ...
                    plot(yzplotVals(1),yzplotVals(2),'sr');
                end
            end
        end
    end
        ...
        if iscell(theta0s{ii})
            for jj = 1:numel(theta0s{ii})
                if isobject(theta0s{ii}{jj}{1})
                    ...
                    plot(yxplotVals(2),yxplotVals(1),'sr');
                end
            end
        end
    end
        ...
        if iscell(theta0s{ii})
            for jj = 1:numel(theta0s{ii})
                if isobject(theta0s{ii}{jj}{1})
                    ...
                    hold on;plot([prevyzplotVals(1) yzplotVals(1)],[prevyzplotVals(2) yzplotVals(2)],'-r');
                end
            end
        end
    end
        ...
        if iscell(theta0s{ii})
            for jj = 1:numel(theta0s{ii})
                if isobject(theta0s{ii}{jj}{1})
                    ...
                    plot([prevyxplotVals(2) yxplotVals(2)],[prevyxplotVals(1) yxplotVals(1)],'-r');
                end
            end
        end
    end

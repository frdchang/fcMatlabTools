...
%==do stage alignment on fov===============================================
1).../fcProcessed/.../expDate/[translateData(paramHash)]/[w2]/translateData(data-w2-t1).tif ... 
2)                                                      /[w3]/translateData(data-w3-t1).tif ... 
3)                                                      /[fcSpotDetection(paramHash1)-w2]/A1/translateData(fcSpotDetection_A1(data-w2-t1)).fits ... 
4)                                                                                       /LLRatio/translateData(fcSpotDetection_LLRatio(data-w2-t1)).fits ...
5)                                                                                       /Conv/translateData(fcSpotDetection_Conv(data-w2-t1)).fits ...
6)                                                      /[fcSpotDetection(paramHash1)-w3]/A1/translateData(fcSpotDetection_A1(data-w3-t1)).fits ... 
7)                                                                                       /LLRatio/translateData(fcSpotDetection_LLRatio(data-w3-t1)).fits ...
8)                                                                                       /Conv/translateData(fcSpotDetection_Conv(data-w3-t1)).fits ...

%==do spectral alignment===================================================
